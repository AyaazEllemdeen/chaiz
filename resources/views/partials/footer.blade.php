<footer class="site-footer">
    <div class="container">
            ...
            <div class="footer-left">
                <span class="disclaimer-trigger" id="disclaimerTrigger">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        viewBox="0 0 16 16" style="margin-right: 6px; vertical-align: middle;">
                    ...
                    <div class="disclaimer-popup">
                        ...
                        <p><strong>comparewarranties.org</strong> is operated by Chaiz, Inc. and serves as a free
                            resource
                        ...
                        <p>When you click on links to Product providers, you consent to share your contact details
                            (name,
                            address, email, and phone number) securely with those providers. This allows them to connect
                            with you about their services. In some cases, we receive a small referral fee for making
                            this
                            introduction.</p>

                        <p><strong>comparewarranties.org</strong> is an advertising platform only and does not sell or
                            offer the Products listed. We do not control the Products or services offered by these
                            providers. If you
                            prefer, you may purchase Product coverage directly through our main site, chaiz.com.</p>

                        <p class="mb-0">Your use of this site is subject to the Terms of Use and Privacy Policy of
                            Chaiz, Inc.
                            as outlined below.</p>
                    </div>
                </span>
        ...
        <div class="footer-bottom">
            <p>&copy; 2026 Comparewarranties.org. All Rights Reserved.</p>
        </div>
    </div>
</footer>
